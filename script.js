...
const oceanFishTypes = {
    ...
    caveTransparentGoby: { name: 'Cave Transparent Goby', color: '#E0E0E0', difficulty: 'Easy', barSize: 80, fishSpeed: 0.0055, fishRandomness: 0.14, fishChangeInterval: 38, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 0.005, maxWeight: 0.02, minLength: 0.02, maxLength: 0.08, spawnWeight: 50 },
    neonGoby: { name: 'Neon Goby', color: '#00BFFF', difficulty: 'Easy', barSize: 80, fishSpeed: 0.0056, fishRandomness: 0.14, fishChangeInterval: 38, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 0.005, maxWeight: 0.02, minLength: 0.02, maxLength: 0.08, spawnWeight: 50 },
    redheadGoby: { name: 'Redhead Goby', color: '#CD5C5C', difficulty: 'Easy', barSize: 80, fishSpeed: 0.0056, fishRandomness: 0.14, fishChangeInterval: 38, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 0.005, maxWeight: 0.02, minLength: 0.02, maxLength: 0.08, spawnWeight: 48 },
    anemoneShrimp: { name: 'Anemone Shrimp', color: '#FF6B6B', difficulty: 'Easy', barSize: 80, fishSpeed: 0.0057, fishRandomness: 0.14, fishChangeInterval: 38, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 0.001, maxWeight: 0.015, minLength: 0.0, maxLength: 0.06, spawnWeight: 48 },
    glassShrimp: { name: 'Glass Shrimp', color: '#F0F8FF', difficulty: 'Easy', barSize: 80, fishSpeed: 0.0057, fishRandomness: 0.14, fishChangeInterval: 38, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 0.001, maxWeight: 0.015, minLength: 0.0, maxLength: 0.06, spawnWeight: 46 },
    sexyShrimp: { name: 'Sexy Shrimp', color: '#FF69B4', difficulty: 'Easy', barSize: 80, fishSpeed: 0.0058, fishRandomness: 0.14, fishChangeInterval: 38, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 0.002, maxWeight: 0.003, minLength: 0.01, maxLength: 0.01, spawnWeight: 45 },
    bumbleBeeShrimp: { name: 'Bumble Bee Shrimp', color: '#FFD700', difficulty: 'Easy', barSize: 80, fishSpeed: 0.0057, fishRandomness: 0.14, fishChangeInterval: 38, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 0.005, maxWeight: 0.007, minLength: 0.02, maxLength: 0.03, spawnWeight: 44 },
    commonJellyfish: { name: 'Common Jellyfish', color: '#E6E6FA', difficulty: 'Easy', barSize: 80, fishSpeed: 0.0058, fishRandomness: 0.15, fishChangeInterval: 39, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 0.001, maxWeight: 1, minLength: 0.0, maxLength: 4.0, spawnWeight: 42 },
    duskyJawfish: { name: 'Dusky Jawfish', color: '#8B7D6B', difficulty: 'Easy', barSize: 80, fishSpeed: 0.0056, fishRandomness: 0.14, fishChangeInterval: 38, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 0.001, maxWeight: 0.004, minLength: 0.0, maxLength: 0.02, spawnWeight: 40 },
    ...
    atlanticSpadefish: { name: 'Atlantic Spadefish', color: '#C0C0C0', difficulty: 'Average', barSize: 70, fishSpeed: 0.007, fishRandomness: 0.2, fishChangeInterval: 45, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 1, maxWeight: 3, minLength: 10, maxLength: 20, spawnWeight: 36 },
    grayAngelfish: { name: 'Gray Angelfish', color: '#808080', difficulty: 'Average', barSize: 70, fishSpeed: 0.007, fishRandomness: 0.2, fishChangeInterval: 45, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 1, maxWeight: 3, minLength: 12, maxLength: 24, spawnWeight: 36 },
    yellowEdgedLyretail: { name: 'Yellow-Edged Lyretail', color: '#FFD700', difficulty: 'Average', barSize: 70, fishSpeed: 0.0072, fishRandomness: 0.21, fishChangeInterval: 46, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 1, maxWeight: 3, minLength: 4, maxLength: 6, spawnWeight: 34 },
    bicolorAngelfish: { name: 'Bicolor Angelfish', color: '#4169E1', difficulty: 'Average', barSize: 70, fishSpeed: 0.0071, fishRandomness: 0.2, fishChangeInterval: 45, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 1, maxWeight: 2, minLength: 4.0, maxLength: 8.0, spawnWeight: 34 },
    blueAngelfish: { name: 'Blue Angelfish', color: '#0000FF', difficulty: 'Average', barSize: 70, fishSpeed: 0.0071, fishRandomness: 0.2, fishChangeInterval: 45, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 1, maxWeight: 4, minLength: 4.0, maxLength: 16.0, spawnWeight: 32 },
    cherubfish: { name: 'Cherubfish', color: '#FF69B4', difficulty: 'Average', barSize: 70, fishSpeed: 0.007, fishRandomness: 0.2, fishChangeInterval: 45, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 0.5, maxWeight: 1, minLength: 2.0, maxLength: 4.0, spawnWeight: 32 },
    coralBeauty: { name: 'Coral Beauty', color: '#FF6B6B', difficulty: 'Average', barSize: 70, fishSpeed: 0.007, fishRandomness: 0.2, fishChangeInterval: 45, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 0.5, maxWeight: 1, minLength: 2.0, maxLength: 4.0, spawnWeight: 30 },
    flameAngelfish: { name: 'Flame Angelfish', color: '#FF4500', difficulty: 'Average', barSize: 70, fishSpeed: 0.0071, fishRandomness: 0.2, fishChangeInterval: 45, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 0.5, maxWeight: 1, minLength: 2.0, maxLength: 4.0, spawnWeight: 28 },
    frenchAngelfish: { name: 'French Angelfish', color: '#2F4F4F', difficulty: 'Average', barSize: 70, fishSpeed: 0.0072, fishRandomness: 0.21, fishChangeInterval: 46, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 1, maxWeight: 3, minLength: 4.0, maxLength: 12.0, spawnWeight: 30 },
    goldflakeAngelfish: { name: 'Goldflake Angelfish', color: '#DAA520', difficulty: 'Average', barSize: 70, fishSpeed: 0.0072, fishRandomness: 0.21, fishChangeInterval: 46, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 1, maxWeight: 3, minLength: 4.0, maxLength: 12.0, spawnWeight: 28 },
    heraldAngelfish: { name: 'Herald Angelfish', color: '#FFD700', difficulty: 'Average', barSize: 70, fishSpeed: 0.007, fishRandomness: 0.2, fishChangeInterval: 45, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 0.5, maxWeight: 1, minLength: 2.0, maxLength: 4.0, spawnWeight: 28 },
    lemonpeelAngelfish: { name: 'Lemonpeel Angelfish', color: '#FFFF00', difficulty: 'Average', barSize: 70, fishSpeed: 0.0071, fishRandomness: 0.2, fishChangeInterval: 45, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 0.5, maxWeight: 1, minLength: 4, maxLength: 5.5, spawnWeight: 26 },
    multicolorAngelfish: { name: 'Multicolor Angelfish', color: '#FF8C00', difficulty: 'Average', barSize: 70, fishSpeed: 0.0071, fishRandomness: 0.2, fishChangeInterval: 45, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 0.5, maxWeight: 1, minLength: 3, maxLength: 3.5, spawnWeight: 26 },
    pearlScaleAngelfish: { name: 'Pearlscale Angelfish', color: '#F0E68C', difficulty: 'Average', barSize: 70, fishSpeed: 0.0072, fishRandomness: 0.21, fishChangeInterval: 46, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 1, maxWeight: 2, minLength: 5, maxLength: 6, spawnWeight: 24 },
    potterAngelfish: { name: "Potter's Angelfish", color: '#FF6347', difficulty: 'Average', barSize: 70, fishSpeed: 0.0071, fishRandomness: 0.2, fishChangeInterval: 45, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 0.5, maxWeight: 1, minLength: 3, maxLength: 4, spawnWeight: 24 },
    queenAngelfish: { name: 'Queen Angelfish', color: '#4169E1', difficulty: 'Average', barSize: 70, fishSpeed: 0.0072, fishRandomness: 0.21, fishChangeInterval: 46, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 1, maxWeight: 3.5, minLength: 14, maxLength: 18, spawnWeight: 28 },
    raspyAngelfish: { name: 'Raspy Angelfish', color: '#CD853F', difficulty: 'Average', barSize: 70, fishSpeed: 0.0071, fishRandomness: 0.2, fishChangeInterval: 45, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 1, maxWeight: 2, minLength: 5, maxLength: 7, spawnWeight: 26 },
    regaliAngelfish: { name: 'Regal Angelfish', color: '#FFD700', difficulty: 'Average', barSize: 70, fishSpeed: 0.0072, fishRandomness: 0.21, fishChangeInterval: 46, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 1, maxWeight: 2, minLength: 6, maxLength: 10, spawnWeight: 22 },
    rockBeautyAngelfish: { name: 'Rock Beauty Angelfish', color: '#FFD700', difficulty: 'Average', barSize: 70, fishSpeed: 0.0071, fishRandomness: 0.2, fishChangeInterval: 45, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 1, maxWeight: 2, minLength: 8, maxLength: 14, spawnWeight: 26 },
    rustyAngelfish: { name: 'Rusty Angelfish', color: '#CD5C5C', difficulty: 'Average', barSize: 70, fishSpeed: 0.007, fishRandomness: 0.2, fishChangeInterval: 45, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 0.5, maxWeight: 1, minLength: 3, maxLength: 4.5, spawnWeight: 24 },
    scribbledAngelfish: { name: 'Scribbled Angelfish', color: '#4682B4', difficulty: 'Average', barSize: 70, fishSpeed: 0.0072, fishRandomness: 0.21, fishChangeInterval: 46, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 1, maxWeight: 3, minLength: 10, maxLength: 14, spawnWeight: 24 },
    sixbarAngelfish: { name: 'Sixbar Angelfish', color: '#F0E68C', difficulty: 'Average', barSize: 70, fishSpeed: 0.0071, fishRandomness: 0.2, fishChangeInterval: 45, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 1, maxWeight: 2, minLength: 16, maxLength: 20, spawnWeight: 22 },
    threeSpotAngelfish: { name: 'Three Spot Angelfish', color: '#FFD700', difficulty: 'Average', barSize: 70, fishSpeed: 0.0071, fishRandomness: 0.2, fishChangeInterval: 45, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 1, maxWeight: 2, minLength: 8, maxLength: 10, spawnWeight: 22 },
    tibicenAngelfish: { name: 'Tibicen Angelfish', color: '#4682B4', difficulty: 'Average', barSize: 70, fishSpeed: 0.0072, fishRandomness: 0.21, fishChangeInterval: 46, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 1, maxWeight: 2, minLength: 6, maxLength: 8, spawnWeight: 20 },
    yellowfinAngelfish: { name: 'Yellowfin Angelfish', color: '#FFD700', difficulty: 'Average', barSize: 70, fishSpeed: 0.0071, fishRandomness: 0.2, fishChangeInterval: 45, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 1, maxWeight: 2, minLength: 5, maxLength: 6, spawnWeight: 20 },
    blackfootedLionfish: { name: 'Blackfooted Lionfish', color: '#8B4513', difficulty: 'Average', barSize: 70, fishSpeed: 0.0068, fishRandomness: 0.19, fishChangeInterval: 44, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 1, maxWeight: 2, minLength: 8, maxLength: 10, spawnWeight: 24 },
    redLionfish: { name: 'Red Lionfish', color: '#DC143C', difficulty: 'Average', barSize: 70, fishSpeed: 0.0069, fishRandomness: 0.19, fishChangeInterval: 44, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 1, maxWeight: 3, minLength: 12, maxLength: 15, spawnWeight: 24 },
    russellsLionfish: { name: "Russell's Lionfish", color: '#CD853F', difficulty: 'Average', barSize: 70, fishSpeed: 0.0069, fishRandomness: 0.19, fishChangeInterval: 44, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 1, maxWeight: 2.5, minLength: 10, maxLength: 12, spawnWeight: 22 },
    turkeyfish: { name: 'Turkeyfish', color: '#8B4513', difficulty: 'Average', barSize: 70, fishSpeed: 0.0068, fishRandomness: 0.19, fishChangeInterval: 44, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 1, maxWeight: 2, minLength: 10, maxLength: 12, spawnWeight: 22 },
    goldrimmedSurgeonfish: { name: 'Goldrimmed Surgeonfish', color: '#FFD700', difficulty: 'Average', barSize: 70, fishSpeed: 0.0073, fishRandomness: 0.21, fishChangeInterval: 46, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 1, maxWeight: 4, minLength: 12, maxLength: 16, spawnWeight: 28 },
    orangeshoulderSurgeonfish: { name: 'Orangeshoulder Surgeonfish', color: '#FF8C00', difficulty: 'Average', barSize: 70, fishSpeed: 0.0073, fishRandomness: 0.21, fishChangeInterval: 46, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 1, maxWeight: 4, minLength: 10, maxLength: 14, spawnWeight: 26 },
    powderBlueTang: { name: 'Powder Blue Tang', color: '#B0E0E6', difficulty: 'Average', barSize: 70, fishSpeed: 0.0074, fishRandomness: 0.21, fishChangeInterval: 46, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 1, maxWeight: 3, minLength: 8, maxLength: 9, spawnWeight: 24 },
    regalTang: { name: 'Regal Tang', color: '#4169E1', difficulty: 'Average', barSize: 70, fishSpeed: 0.0074, fishRandomness: 0.21, fishChangeInterval: 46, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 1, maxWeight: 3, minLength: 10, maxLength: 12, spawnWeight: 26 },
    sailfinTang: { name: 'Sailfin Tang', color: '#4682B4', difficulty: 'Average', barSize: 70, fishSpeed: 0.0074, fishRandomness: 0.21, fishChangeInterval: 46, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 1, maxWeight: 4, minLength: 12, maxLength: 16, spawnWeight: 26 },
    yellowTang: { name: 'Yellow Tang', color: '#FFFF00', difficulty: 'Average', barSize: 70, fishSpeed: 0.0073, fishRandomness: 0.21, fishChangeInterval: 46, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 0.5, maxWeight: 2, minLength: 7, maxLength: 8, spawnWeight: 28 },
    zebrasomaTang: { name: 'Zebrasoma Tang', color: '#F0E68C', difficulty: 'Average', barSize: 70, fishSpeed: 0.0074, fishRandomness: 0.21, fishChangeInterval: 46, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 1, maxWeight: 3, minLength: 8, maxLength: 10, spawnWeight: 24 },
    goldSpottedRabbitfish: { name: 'Gold-Spotted Rabbitfish', color: '#FFD700', difficulty: 'Average', barSize: 70, fishSpeed: 0.0072, fishRandomness: 0.21, fishChangeInterval: 46, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 1, maxWeight: 4, minLength: 12, maxLength: 16, spawnWeight: 28 },
    magnificentFoxface: { name: 'Magnificent Foxface', color: '#F0E68C', difficulty: 'Average', barSize: 70, fishSpeed: 0.0072, fishRandomness: 0.21, fishChangeInterval: 46, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 1, maxWeight: 4, minLength: 9, maxLength: 10, spawnWeight: 26 },
    oneSpotFoxface: { name: 'One-Spot Foxface', color: '#FFD700', difficulty: 'Average', barSize: 70, fishSpeed: 0.0072, fishRandomness: 0.21, fishChangeInterval: 46, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 1, maxWeight: 4, minLength: 8, maxLength: 9, spawnWeight: 24 },
    clarkiiAnemonefish: { name: 'Clarkii Anemonefish', color: '#FF8C00', difficulty: 'Average', barSize: 70, fishSpeed: 0.0071, fishRandomness: 0.2, fishChangeInterval: 45, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 0.5, maxWeight: 3, minLength: 4, maxLength: 6, spawnWeight: 32 },
    maroonClownfish: { name: 'Maroon Clownfish', color: '#800000', difficulty: 'Average', barSize: 70, fishSpeed: 0.0072, fishRandomness: 0.21, fishChangeInterval: 46, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 0.5, maxWeight: 4, minLength: 5, maxLength: 6.5, spawnWeight: 30 },
    sebaeAnemonefish: { name: 'Sebae Anemonefish', color: '#FF6347', difficulty: 'Average', barSize: 70, fishSpeed: 0.0071, fishRandomness: 0.2, fishChangeInterval: 45, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 0.5, maxWeight: 3, minLength: 4, maxLength: 6, spawnWeight: 28 },
    yellowBoxfish: { name: 'Yellow Boxfish', color: '#FFFF00', difficulty: 'Average', barSize: 70, fishSpeed: 0.0068, fishRandomness: 0.19, fishChangeInterval: 44, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 1, maxWeight: 3, minLength: 12, maxLength: 18, spawnWeight: 30 },
    bluespottedBoxfish: { name: 'Bluespotted Boxfish', color: '#4682B4', difficulty: 'Average', barSize: 70, fishSpeed: 0.0068, fishRandomness: 0.19, fishChangeInterval: 44, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 1, maxWeight: 3, minLength: 12, maxLength: 18, spawnWeight: 28 },
    greenspottedPuffer: { name: 'Greenspotted Puffer', color: '#228B22', difficulty: 'Average', barSize: 70, fishSpeed: 0.0069, fishRandomness: 0.19, fishChangeInterval: 44, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 1, maxWeight: 3, minLength: 5, maxLength: 6.5, spawnWeight: 28 },
    orangespottedFilefish: { name: 'Orangespotted Filefish', color: '#FF8C00', difficulty: 'Average', barSize: 70, fishSpeed: 0.007, fishRandomness: 0.2, fishChangeInterval: 45, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 1, maxWeight: 2, minLength: 6, maxLength: 8, spawnWeight: 26 },
    radiateFilefish: { name: 'Radiate Filefish', color: '#F0E68C', difficulty: 'Average', barSize: 70, fishSpeed: 0.007, fishRandomness: 0.2, fishChangeInterval: 45, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 1, maxWeight: 2, minLength: 6, maxLength: 8, spawnWeight: 26 },
    scopasFilefish: { name: 'Scopas Filefish', color: '#CD853F', difficulty: 'Average', barSize: 70, fishSpeed: 0.007, fishRandomness: 0.2, fishChangeInterval: 45, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 1, maxWeight: 2, minLength: 6, maxLength: 8, spawnWeight: 24 },
    threadfinFilefish: { name: 'Threadfin Filefish', color: '#8B7D6B', difficulty: 'Average', barSize: 70, fishSpeed: 0.007, fishRandomness: 0.2, fishChangeInterval: 45, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 1, maxWeight: 2, minLength: 6, maxLength: 8, spawnWeight: 24 },
    twoBarredRabbitfish: { name: 'Two-Barred Rabbitfish', color: '#F0E68C', difficulty: 'Average', barSize: 70, fishSpeed: 0.0072, fishRandomness: 0.21, fishChangeInterval: 46, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 1, maxWeight: 4, minLength: 10, maxLength: 14, spawnWeight: 24 },
    cherryBarb: { name: 'Cherry Barb', color: '#DC143C', difficulty: 'Average', barSize: 70, fishSpeed: 0.0071, fishRandomness: 0.2, fishChangeInterval: 45, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 1, maxWeight: 2, minLength: 6, maxLength: 8, spawnWeight: 28 },
    lanceButterfly: { name: 'Lance Butterfly', color: '#FFD700', difficulty: 'Average', barSize: 70, fishSpeed: 0.0072, fishRandomness: 0.21, fishChangeInterval: 46, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 1, maxWeight: 3, minLength: 6, maxLength: 8, spawnWeight: 26 },
    raccoonButterflyfish: { name: 'Raccoon Butterflyfish', color: '#F0E68C', difficulty: 'Average', barSize: 70, fishSpeed: 0.0072, fishRandomness: 0.21, fishChangeInterval: 46, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 1, maxWeight: 4, minLength: 7, maxLength: 8, spawnWeight: 26 },
    threadfinButterflyfish: { name: 'Threadfin Butterflyfish', color: '#FFD700', difficulty: 'Average', barSize: 70, fishSpeed: 0.0072, fishRandomness: 0.21, fishChangeInterval: 46, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 1, maxWeight: 4, minLength: 6, maxLength: 9, spawnWeight: 24 },
    doublebarBream: { name: 'Doublebar Bream', color: '#C0C0C0', difficulty: 'Average', barSize: 70, fishSpeed: 0.0073, fishRandomness: 0.21, fishChangeInterval: 46, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 1, maxWeight: 5, minLength: 10, maxLength: 14, spawnWeight: 28 },
    barredFlagfish: { name: 'Barred Flagfish', color: '#FF6347', difficulty: 'Average', barSize: 70, fishSpeed: 0.0071, fishRandomness: 0.2, fishChangeInterval: 45, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 1, maxWeight: 3, minLength: 6, maxLength: 8, spawnWeight: 26 },
    peacockGrouper: { name: 'Peacock Grouper', color: '#4169E1', difficulty: 'Average', barSize: 70, fishSpeed: 0.0074, fishRandomness: 0.22, fishChangeInterval: 47, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 2, maxWeight: 10, minLength: 16, maxLength: 28, spawnWeight: 30 },
    goldbarBass: { name: 'Goldbar Bass', color: '#DAA520', difficulty: 'Average', barSize: 70, fishSpeed: 0.0073, fishRandomness: 0.21, fishChangeInterval: 46, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 1, maxWeight: 5, minLength: 10, maxLength: 14, spawnWeight: 28 },
    halfblackMinibass: { name: 'Halfblack Minibass', color: '#2F4F4F', difficulty: 'Average', barSize: 70, fishSpeed: 0.0071, fishRandomness: 0.2, fishChangeInterval: 45, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 1, maxWeight: 3, minLength: 4, maxLength: 5, spawnWeight: 26 },
    goldenGoatfish: { name: 'Golden Goatfish', color: '#DAA520', difficulty: 'Average', barSize: 70, fishSpeed: 0.0073, fishRandomness: 0.21, fishChangeInterval: 46, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 1, maxWeight: 4, minLength: 12, maxLength: 16, spawnWeight: 28 },
    yellowfinGoatfish: { name: 'Yellowfin Goatfish', color: '#FFD700', difficulty: 'Average', barSize: 70, fishSpeed: 0.0073, fishRandomness: 0.21, fishChangeInterval: 46, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 1, maxWeight: 4, minLength: 12, maxLength: 20, spawnWeight: 26 },
    bannerfish: { name: 'Bannerfish', color: '#F0E68C', difficulty: 'Average', barSize: 70, fishSpeed: 0.0072, fishRandomness: 0.21, fishChangeInterval: 46, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 1, maxWeight: 3, minLength: 6, maxLength: 9, spawnWeight: 26 },
    butterflyBream: { name: 'Butterfly Bream', color: '#FFD700', difficulty: 'Average', barSize: 70, fishSpeed: 0.0072, fishRandomness: 0.21, fishChangeInterval: 46, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 1, maxWeight: 4, minLength: 10, maxLength: 14, spawnWeight: 24 },
    spotfinSquirrelfish: { name: 'Spotfin Squirrelfish', color: '#FF6347', difficulty: 'Average', barSize: 70, fishSpeed: 0.0071, fishRandomness: 0.2, fishChangeInterval: 45, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 1, maxWeight: 3, minLength: 6, maxLength: 8, spawnWeight: 26 },
    blueCrab: { name: 'Blue Crab', color: '#4682B4', difficulty: 'Average', barSize: 70, fishSpeed: 0.0067, fishRandomness: 0.19, fishChangeInterval: 44, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 0.5, maxWeight: 1, minLength: 3, maxLength: 9, spawnWeight: 32 },
    arrowCrab: { name: 'Arrow Crab', color: '#CD853F', difficulty: 'Average', barSize: 70, fishSpeed: 0.0067, fishRandomness: 0.19, fishChangeInterval: 44, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 0.1, maxWeight: 0.3, minLength: 3, maxLength: 6, spawnWeight: 30 },
    emeraldCrab: { name: 'Emerald Crab', color: '#50C878', difficulty: 'Average', barSize: 70, fishSpeed: 0.0067, fishRandomness: 0.19, fishChangeInterval: 44, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 0.1, maxWeight: 0.5, minLength: 1, maxLength: 2, spawnWeight: 30 },
    boxJellyfish: { name: 'Box Jellyfish', color: '#E6E6FA', difficulty: 'Average', barSize: 70, fishSpeed: 0.0065, fishRandomness: 0.18, fishChangeInterval: 43, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 0.5, maxWeight: 4, minLength: 4, maxLength: 10, spawnWeight: 28 },
    moonJellyfish: { name: 'Moon Jellyfish', color: '#F0F8FF', difficulty: 'Average', barSize: 70, fishSpeed: 0.0065, fishRandomness: 0.18, fishChangeInterval: 43, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 1, maxWeight: 5, minLength: 10, maxLength: 16, spawnWeight: 32 },
    cannonballJellyfish: { name: 'Cannonball Jellyfish', color: '#DCDCDC', difficulty: 'Average', barSize: 70, fishSpeed: 0.0066, fishRandomness: 0.18, fishChangeInterval: 43, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 1, maxWeight: 2, minLength: 5, maxLength: 7, spawnWeight: 30 },
    pacificSeaNettle: { name: 'Pacific Sea Nettle', color: '#FFA07A', difficulty: 'Average', barSize: 70, fishSpeed: 0.0065, fishRandomness: 0.18, fishChangeInterval: 43, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 1, maxWeight: 10, minLength: 12, maxLength: 36, spawnWeight: 28 },
    
    // Larger fish (5-50 lbs) - Hard difficulty
    porcupinePuffer: { name: 'Porcupine Puffer', color: '#F0E68C', difficulty: 'Hard', barSize: 60, fishSpeed: 0.008, fishRandomness: 0.25, fishChangeInterval: 50, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 5, maxWeight: 20, minLength: 12, maxLength: 36, spawnWeight: 22 },
    dogioPuffer: { name: 'Dogio Puffer', color: '#8B7D6B', difficulty: 'Hard', barSize: 60, fishSpeed: 0.0079, fishRandomness: 0.24, fishChangeInterval: 49, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 5, maxWeight: 15, minLength: 10, maxLength: 20, spawnWeight: 20 },
    guineafowlPuffer: { name: 'Guineafowl Puffer', color: '#FFD700', difficulty: 'Hard', barSize: 60, fishSpeed: 0.0079, fishRandomness: 0.24, fishChangeInterval: 49, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 5, maxWeight: 20, minLength: 10, maxLength: 20, spawnWeight: 20 },
    mapPuffer: { name: 'Map Puffer', color: '#CD853F', difficulty: 'Hard', barSize: 60, fishSpeed: 0.008, fishRandomness: 0.25, fishChangeInterval: 50, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 5, maxWeight: 25, minLength: 14, maxLength: 26, spawnWeight: 18 },
    starsandStripesPuffer: { name: 'Stars and Stripes Puffer', color: '#F0E68C', difficulty: 'Hard', barSize: 60, fishSpeed: 0.008, fishRandomness: 0.25, fishChangeInterval: 50, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 5, maxWeight: 20, minLength: 12, maxLength: 18, spawnWeight: 18 },
    clownTriggerfish: { name: 'Clown Triggerfish', color: '#FFD700', difficulty: 'Hard', barSize: 60, fishSpeed: 0.0082, fishRandomness: 0.26, fishChangeInterval: 51, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 5, maxWeight: 15, minLength: 12, maxLength: 20, spawnWeight: 20 },
    picassoTriggerfish: { name: 'Picasso Triggerfish', color: '#CD853F', difficulty: 'Hard', barSize: 60, fishSpeed: 0.0081, fishRandomness: 0.25, fishChangeInterval: 50, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 5, maxWeight: 12, minLength: 8, maxLength: 12, spawnWeight: 20 },
    nigerTriggerfish: { name: 'Niger Triggerfish', color: '#4B0082', difficulty: 'Hard', barSize: 60, fishSpeed: 0.0081, fishRandomness: 0.25, fishChangeInterval: 50, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 5, maxWeight: 15, minLength: 12, maxLength: 20, spawnWeight: 18 },
    blueTriggerfish: { name: 'Blue Triggerfish', color: '#4169E1', difficulty: 'Hard', barSize: 60, fishSpeed: 0.008, fishRandomness: 0.25, fishChangeInterval: 50, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 5, maxWeight: 18, minLength: 12, maxLength: 16, spawnWeight: 18 },
    dogfaceBoxfish: { name: 'Dogface Boxfish', color: '#FFD700', difficulty: 'Hard', barSize: 60, fishSpeed: 0.0078, fishRandomness: 0.24, fishChangeInterval: 49, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 5, maxWeight: 15, minLength: 10, maxLength: 14, spawnWeight: 20 },
    longhorncowfish: { name: 'Longhorn Cowfish', color: '#FFD700', difficulty: 'Hard', barSize: 60, fishSpeed: 0.0077, fishRandomness: 0.23, fishChangeInterval: 48, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 5, maxWeight: 10, minLength: 12, maxLength: 18, spawnWeight: 20 },
    scrawledCowfish: { name: 'Scrawled Cowfish', color: '#4682B4', difficulty: 'Hard', barSize: 60, fishSpeed: 0.0077, fishRandomness: 0.23, fishChangeInterval: 48, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 5, maxWeight: 10, minLength: 10, maxLength: 18, spawnWeight: 18 },
    longspineBatfish: { name: 'Longspine Batfish', color: '#C0C0C0', difficulty: 'Hard', barSize: 60, fishSpeed: 0.0076, fishRandomness: 0.23, fishChangeInterval: 48, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 5, maxWeight: 15, minLength: 12, maxLength: 18, spawnWeight: 18 },
    polkadotBatfish: { name: 'Polkadot Batfish', color: '#2F4F4F', difficulty: 'Hard', barSize: 60, fishSpeed: 0.0076, fishRandomness: 0.23, fishChangeInterval: 48, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 5, maxWeight: 15, minLength: 10, maxLength: 16, spawnWeight: 16 },
    pinnateBatfish: { name: 'Pinnate Batfish', color: '#D3D3D3', difficulty: 'Average', barSize: 70, fishSpeed: 0.007, fishRandomness: 0.2, fishChangeInterval: 45, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 1, maxWeight: 3, minLength: 8, maxLength: 12, spawnWeight: 26 },
    snowflakeMorayEel: { name: 'Snowflake Moray Eel', color: '#F0E68C', difficulty: 'Hard', barSize: 60, fishSpeed: 0.0082, fishRandomness: 0.26, fishChangeInterval: 51, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 5, maxWeight: 15, minLength: 18, maxLength: 36, spawnWeight: 22 },
    goldenDwarfMorayEel: { name: 'Golden Dwarf Moray Eel', color: '#DAA520', difficulty: 'Hard', barSize: 60, fishSpeed: 0.0081, fishRandomness: 0.25, fishChangeInterval: 50, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 5, maxWeight: 10, minLength: 12, maxLength: 14, spawnWeight: 20 },
    chainlinkMorayEel: { name: 'Chainlink Moray Eel', color: '#696969', difficulty: 'Hard', barSize: 60, fishSpeed: 0.0082, fishRandomness: 0.26, fishChangeInterval: 51, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 5, maxWeight: 20, minLength: 18, maxLength: 28, spawnWeight: 18 },
    zebraEel: { name: 'Zebra Eel', color: '#FFD700', difficulty: 'Hard', barSize: 60, fishSpeed: 0.0082, fishRandomness: 0.26, fishChangeInterval: 51, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 5, maxWeight: 15, minLength: 24, maxLength: 40, spawnWeight: 18 },
    dragonEel: { name: 'Dragon Eel', color: '#8B4513', difficulty: 'Hard', barSize: 60, fishSpeed: 0.0083, fishRandomness: 0.27, fishChangeInterval: 52, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 10, maxWeight: 30, minLength: 30, maxLength: 36, spawnWeight: 16 },
    ribbonEel: { name: 'Ribbon Eel', color: '#0000FF', difficulty: 'Hard', barSize: 60, fishSpeed: 0.0083, fishRandomness: 0.27, fishChangeInterval: 52, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 5, maxWeight: 10, minLength: 30, maxLength: 50, spawnWeight: 16 },
    peacockFlounder: { name: 'Peacock Flounder', color: '#8B7D6B', difficulty: 'Hard', barSize: 60, fishSpeed: 0.0075, fishRandomness: 0.23, fishChangeInterval: 48, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 5, maxWeight: 12, minLength: 12, maxLength: 18, spawnWeight: 20 },
    pantherFlounder: { name: 'Panther Flounder', color: '#2F4F4F', difficulty: 'Hard', barSize: 60, fishSpeed: 0.0075, fishRandomness: 0.23, fishChangeInterval: 48, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 5, maxWeight: 12, minLength: 10, maxLength: 14, spawnWeight: 18 },
    sargassumFrogfish: { name: 'Sargassum Frogfish', color: '#FFD700', difficulty: 'Hard', barSize: 60, fishSpeed: 0.0073, fishRandomness: 0.22, fishChangeInterval: 47, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 5, maxWeight: 8, minLength: 6, maxLength: 8, spawnWeight: 16 },
    giantFrogfish: { name: 'Giant Frogfish', color: '#FF6347', difficulty: 'Hard', barSize: 60, fishSpeed: 0.0074, fishRandomness: 0.22, fishChangeInterval: 47, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 5, maxWeight: 10, minLength: 12, maxLength: 16, spawnWeight: 14 },
    blueStripeSnapper: { name: 'Blue Stripe Snapper', color: '#4682B4', difficulty: 'Hard', barSize: 60, fishSpeed: 0.0081, fishRandomness: 0.25, fishChangeInterval: 50, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 5, maxWeight: 25, minLength: 14, maxLength: 24, spawnWeight: 24 },
    oneSpotSnapper: { name: 'One-Spot Snapper', color: '#FFD700', difficulty: 'Hard', barSize: 60, fishSpeed: 0.0081, fishRandomness: 0.25, fishChangeInterval: 50, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 5, maxWeight: 20, minLength: 12, maxLength: 20, spawnWeight: 22 },
    harlequinTilefish: { name: 'Harlequin Tilefish', color: '#4169E1', difficulty: 'Hard', barSize: 60, fishSpeed: 0.0079, fishRandomness: 0.24, fishChangeInterval: 49, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 5, maxWeight: 15, minLength: 12, maxLength: 18, spawnWeight: 20 },
    blueDotJawfish: { name: 'Blue Dot Jawfish', color: '#4682B4', difficulty: 'Hard', barSize: 60, fishSpeed: 0.0078, fishRandomness: 0.24, fishChangeInterval: 49, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 5, maxWeight: 10, minLength: 4, maxLength: 6, spawnWeight: 18 },
    copperbandbutterflyfish: { name: 'Copperband Butterflyfish', color: '#FF8C00', difficulty: 'Hard', barSize: 60, fishSpeed: 0.0077, fishRandomness: 0.23, fishChangeInterval: 48, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 5, maxWeight: 8, minLength: 6, maxLength: 8, spawnWeight: 20 },
    longnoseButterfly: { name: 'Longnose Butterfly', color: '#FFD700', difficulty: 'Hard', barSize: 60, fishSpeed: 0.0077, fishRandomness: 0.23, fishChangeInterval: 48, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 5, maxWeight: 8, minLength: 6, maxLength: 9, spawnWeight: 20 },
    saddledButterfly: { name: 'Saddled Butterfly', color: '#F0E68C', difficulty: 'Hard', barSize: 60, fishSpeed: 0.0077, fishRandomness: 0.23, fishChangeInterval: 48, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 5, maxWeight: 10, minLength: 7, maxLength: 10, spawnWeight: 18 },
    bluefaceAngelfish: { name: 'Blueface Angelfish', color: '#1E90FF', difficulty: 'Hard', barSize: 60, fishSpeed: 0.0079, fishRandomness: 0.24, fishChangeInterval: 49, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 5, maxWeight: 8, minLength: 10, maxLength: 15, spawnWeight: 18 },
    emperorAngelfish: { name: 'Emperor Angelfish', color: '#4169E1', difficulty: 'Hard', barSize: 60, fishSpeed: 0.008, fishRandomness: 0.25, fishChangeInterval: 50, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 5, maxWeight: 7, minLength: 12, maxLength: 15, spawnWeight: 16 },
    koranAngelfish: { name: 'Koran Angelfish', color: '#4682B4', difficulty: 'Hard', barSize: 60, fishSpeed: 0.0079, fishRandomness: 0.24, fishChangeInterval: 49, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 5, maxWeight: 7, minLength: 10, maxLength: 15, spawnWeight: 16 },
    majesticAngelfish: { name: 'Majestic Angelfish', color: '#FFD700', difficulty: 'Hard', barSize: 60, fishSpeed: 0.008, fishRandomness: 0.25, fishChangeInterval: 50, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 5, maxWeight: 7, minLength: 10, maxLength: 12, spawnWeight: 14 },
    yellowmaskAngelfish: { name: 'Yellowmask Angelfish', color: '#FFD700', difficulty: 'Hard', barSize: 60, fishSpeed: 0.0079, fishRandomness: 0.24, fishChangeInterval: 49, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 5, maxWeight: 8, minLength: 8, maxLength: 11, spawnWeight: 14 },
    miniataGrouper: { name: 'Miniata Grouper', color: '#DC143C', difficulty: 'Hard', barSize: 60, fishSpeed: 0.0083, fishRandomness: 0.27, fishChangeInterval: 52, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 10, maxWeight: 40, minLength: 16, maxLength: 24, spawnWeight: 20 },
    coralGrouper: { name: 'Coral Grouper', color: '#FF6347', difficulty: 'Hard', barSize: 60, fishSpeed: 0.0082, fishRandomness: 0.26, fishChangeInterval: 51, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 10, maxWeight: 30, minLength: 16, maxLength: 24, spawnWeight: 20 },
    polkadotGrouper: { name: 'Polkadot Grouper', color: '#CD853F', difficulty: 'Hard', barSize: 60, fishSpeed: 0.0082, fishRandomness: 0.26, fishChangeInterval: 51, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 10, maxWeight: 35, minLength: 18, maxLength: 32, spawnWeight: 18 },
    blackEdgedGrouper: { name: 'Black-Edged Grouper', color: '#2F4F4F', difficulty: 'Hard', barSize: 60, fishSpeed: 0.0083, fishRandomness: 0.27, fishChangeInterval: 52, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 10, maxWeight: 50, minLength: 24, maxLength: 36, spawnWeight: 18 },
    yellowfinGrouper: { name: 'Yellowfin Grouper', color: '#FFD700', difficulty: 'Hard', barSize: 60, fishSpeed: 0.0082, fishRandomness: 0.26, fishChangeInterval: 51, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 10, maxWeight: 40, minLength: 18, maxLength: 36, spawnWeight: 16 },
    cometGrouper: { name: 'Comet Grouper', color: '#FF6B6B', difficulty: 'Hard', barSize: 60, fishSpeed: 0.0082, fishRandomness: 0.26, fishChangeInterval: 51, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 10, maxWeight: 30, minLength: 16, maxLength: 24, spawnWeight: 16 },
    pantherGrouper: { name: 'Panther Grouper', color: '#2F4F4F', difficulty: 'Hard', barSize: 60, fishSpeed: 0.0083, fishRandomness: 0.27, fishChangeInterval: 52, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 10, maxWeight: 50, minLength: 20, maxLength: 28, spawnWeight: 14 },
    blacktipGrouper: { name: 'Blacktip Grouper', color: '#8B4513', difficulty: 'Hard', barSize: 60, fishSpeed: 0.0082, fishRandomness: 0.26, fishChangeInterval: 51, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 10, maxWeight: 35, minLength: 18, maxLength: 32, spawnWeight: 16 },
    lunarGrouper: { name: 'Lunar Grouper', color: '#F0E68C', difficulty: 'Hard', barSize: 60, fishSpeed: 0.0082, fishRandomness: 0.26, fishChangeInterval: 51, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 10, maxWeight: 30, minLength: 16, maxLength: 24, spawnWeight: 14 },
    squareSpotGrouper: { name: 'Square Spot Grouper', color: '#CD853F', difficulty: 'Hard', barSize: 60, fishSpeed: 0.0082, fishRandomness: 0.26, fishChangeInterval: 51, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 10, maxWeight: 35, minLength: 18, maxLength: 28, spawnWeight: 14 },
    redspottedGrouper: { name: 'Redspotted Grouper', color: '#DC143C', difficulty: 'Hard', barSize: 60, fishSpeed: 0.0082, fishRandomness: 0.26, fishChangeInterval: 51, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 10, maxWeight: 40, minLength: 20, maxLength: 30, spawnWeight: 14 },
    goldribbonGrouper: { name: 'Goldribbon Grouper', color: '#FFD700', difficulty: 'Hard', barSize: 60, fishSpeed: 0.0082, fishRandomness: 0.26, fishChangeInterval: 51, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 10, maxWeight: 35, minLength: 18, maxLength: 30, spawnWeight: 12 },
    greasyGrouper: { name: 'Greasy Grouper', color: '#8B7D6B', difficulty: 'Hard', barSize: 60, fishSpeed: 0.0082, fishRandomness: 0.26, fishChangeInterval: 51, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 10, maxWeight: 30, minLength: 16, maxLength: 28, spawnWeight: 12 },
    leopardGrouper: { name: 'Leopard Grouper', color: '#CD853F', difficulty: 'Hard', barSize: 60, fishSpeed: 0.0083, fishRandomness: 0.27, fishChangeInterval: 52, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 10, maxWeight: 45, minLength: 20, maxLength: 32, spawnWeight: 12 },
    barredSoapfish: { name: 'Barred Soapfish', color: '#8B7D6B', difficulty: 'Hard', barSize: 60, fishSpeed: 0.0081, fishRandomness: 0.25, fishChangeInterval: 50, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 5, maxWeight: 12, minLength: 10, maxLength: 12, spawnWeight: 16 },
    sixlinedSoapfish: { name: 'Sixlined Soapfish', color: '#696969', difficulty: 'Hard', barSize: 60, fishSpeed: 0.0081, fishRandomness: 0.25, fishChangeInterval: 50, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 5, maxWeight: 10, minLength: 8, maxLength: 10, spawnWeight: 14 },
    bluePinstripeHogfish: { name: 'Blue Pinstripe Hogfish', color: '#4682B4', difficulty: 'Hard', barSize: 60, fishSpeed: 0.008, fishRandomness: 0.25, fishChangeInterval: 50, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 5, maxWeight: 15, minLength: 10, maxLength: 14, spawnWeight: 18 },
    cubanHogfish: { name: 'Cuban Hogfish', color: '#FF6347', difficulty: 'Hard', barSize: 60, fishSpeed: 0.008, fishRandomness: 0.25, fishChangeInterval: 50, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 5, maxWeight: 15, minLength: 12, maxLength: 16, spawnWeight: 18 },
    spotfishHogfish: { name: 'Spotfin Hogfish', color: '#DC143C', difficulty: 'Hard', barSize: 60, fishSpeed: 0.008, fishRandomness: 0.25, fishChangeInterval: 50, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 5, maxWeight: 12, minLength: 8, maxLength: 12, spawnWeight: 16 },
        spotfishHogfish: { name: 'Spotfin Hogfish', color: '#DC143C', difficulty: 'Hard', barSize: 60, fishSpeed: 0.008, fishRandomness: 0.25, fishChangeInterval: 50, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 5, maxWeight: 12, minLength: 8, maxLength: 12, spawnWeight: 16 },
    peacockParrotfish: { name: 'Peacock Parrotfish', color: '#00CED1', difficulty: 'Hard', barSize: 60, fishSpeed: 0.0082, fishRandomness: 0.26, fishChangeInterval: 51, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 10, maxWeight: 25, minLength: 12, maxLength: 18, spawnWeight: 18 },
        spanishHogfish: { name: 'Spanish Hogfish', color: '#FF8C00', difficulty: 'Hard', barSize: 60, fishSpeed: 0.008, fishRandomness: 0.25, fishChangeInterval: 50, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 5, maxWeight: 10, minLength: 8, maxLength: 14, spawnWeight: 16 },
    cleanerWrasse: { name: 'Cleaner Wrasse', color: '#4169E1', difficulty: 'Average', barSize: 70, fishSpeed: 0.0073, fishRandomness: 0.21, fishChangeInterval: 46, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 0.2, maxWeight: 0.5, minLength: 2, maxLength: 4, spawnWeight: 28 },
        peacockParrotfish: { name: 'Peacock Parrotfish', color: '#00CED1', difficulty: 'Hard', barSize: 60, fishSpeed: 0.0082, fishRandomness: 0.26, fishChangeInterval: 51, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 10, maxWeight: 25, minLength: 12, maxLength: 18, spawnWeight: 18 },
    dividedWrasse: { name: 'Divided Wrasse', color: '#FF6347', difficulty: 'Average', barSize: 70, fishSpeed: 0.0073, fishRandomness: 0.21, fishChangeInterval: 46, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 1, maxWeight: 4, minLength: 10, maxLength: 12, spawnWeight: 24 },
        midnightParrotfish: { name: 'Midnight Parrotfish', color: '#191970', difficulty: 'Hard', barSize: 60, fishSpeed: 0.0082, fishRandomness: 0.26, fishChangeInterval: 51, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 10, maxWeight: 30, minLength: 16, maxLength: 30, spawnWeight: 16 },
    dragonWrasse: { name: 'Dragon Wrasse', color: '#8B4513', difficulty: 'Average', barSize: 70, fishSpeed: 0.0075, fishRandomness: 0.22, fishChangeInterval: 47, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 2, maxWeight: 5, minLength: 8, maxLength: 10, spawnWeight: 20 },
    leopardWrasse: { name: 'Leopard Wrasse', color: '#DEB887', difficulty: 'Average', barSize: 70, fishSpeed: 0.0073, fishRandomness: 0.21, fishChangeInterval: 46, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 1, maxWeight: 3, minLength: 4, maxLength: 6, spawnWeight: 24 },
    lunarWrasse: { name: 'Lunar Wrasse', color: '#7FFF00', difficulty: 'Average', barSize: 70, fishSpeed: 0.0074, fishRandomness: 0.21, fishChangeInterval: 46, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 2, maxWeight: 4, minLength: 8, maxLength: 12, spawnWeight: 22 },
    sixlineWrasse: { name: 'Sixline Wrasse', color: '#FF4500', difficulty: 'Average', barSize: 70, fishSpeed: 0.0072, fishRandomness: 0.20, fishChangeInterval: 45, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 0.1, maxWeight: 0.3, minLength: 2, maxLength: 3, spawnWeight: 30 },
    melanurusWrasse: { name: 'Melanurus Wrasse', color: '#4682B4', difficulty: 'Average', barSize: 70, fishSpeed: 0.0073, fishRandomness: 0.21, fishChangeInterval: 46, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 1, maxWeight: 3, minLength: 3, maxLength: 5, spawnWeight: 26 },
    blueprintSweetlips: { name: 'Blueprint Sweetlips', color: '#4682B4', difficulty: 'Hard', barSize: 60, fishSpeed: 0.0081, fishRandomness: 0.25, fishChangeInterval: 50, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 5, maxWeight: 20, minLength: 14, maxLength: 20, spawnWeight: 18 },
    clownSweetlips: { name: 'Clown Sweetlips', color: '#FFD700', difficulty: 'Hard', barSize: 60, fishSpeed: 0.0081, fishRandomness: 0.25, fishChangeInterval: 50, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 5, maxWeight: 25, minLength: 16, maxLength: 28, spawnWeight: 16 },
    orientalSweetlips: { name: 'Oriental Sweetlips', color: '#F0E68C', difficulty: 'Hard', barSize: 60, fishSpeed: 0.0081, fishRandomness: 0.25, fishChangeInterval: 50, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 5, maxWeight: 30, minLength: 18, maxLength: 28, spawnWeight: 16 },
    harlequinSweetlips: { name: 'Harlequin Sweetlips', color: '#FFD700', difficulty: 'Hard', barSize: 60, fishSpeed: 0.0081, fishRandomness: 0.25, fishChangeInterval: 50, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 5, maxWeight: 20, minLength: 14, maxLength: 18, spawnWeight: 16 },
    paintedGrunt: { name: 'Painted Grunt', color: '#FFD700', difficulty: 'Hard', barSize: 60, fishSpeed: 0.008, fishRandomness: 0.25, fishChangeInterval: 50, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 5, maxWeight: 15, minLength: 10, maxLength: 16, spawnWeight: 18 },
    goldspottedBoxfish: { name: 'Goldspotted Boxfish', color: '#FFD700', difficulty: 'Hard', barSize: 60, fishSpeed: 0.0078, fishRandomness: 0.24, fishChangeInterval: 49, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 5, maxWeight: 12, minLength: 8, maxLength: 12, spawnWeight: 16 },
    scrawledFilefish: { name: 'Scrawled Filefish', color: '#8B7D6B', difficulty: 'Hard', barSize: 60, fishSpeed: 0.0079, fishRandomness: 0.24, fishChangeInterval: 49, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 5, maxWeight: 15, minLength: 8, maxLength: 14, spawnWeight: 16 },
    whiteSpottedBurrfish: { name: 'White-Spotted Burrfish', color: '#F0E68C', difficulty: 'Hard', barSize: 60, fishSpeed: 0.008, fishRandomness: 0.25, fishChangeInterval: 50, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 5, maxWeight: 10, minLength: 10, maxLength: 18, spawnWeight: 18 },
    blueHeadGoby: { name: 'Blue Head Goby', color: '#1E90FF', difficulty: 'Hard', barSize: 60, fishSpeed: 0.0077, fishRandomness: 0.23, fishChangeInterval: 48, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 5, maxWeight: 8, minLength: 3, maxLength: 5, spawnWeight: 16 },
    fireGoby: { name: 'Fire Goby', color: '#FF4500', difficulty: 'Hard', barSize: 60, fishSpeed: 0.0077, fishRandomness: 0.23, fishChangeInterval: 48, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 5, maxWeight: 8, minLength: 2, maxLength: 3, spawnWeight: 14 },
    dragonGoby: { name: 'Dragon Goby', color: '#696969', difficulty: 'Hard', barSize: 60, fishSpeed: 0.0078, fishRandomness: 0.24, fishChangeInterval: 49, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 5, maxWeight: 10, minLength: 8, maxLength: 10, spawnWeight: 14 },
    peppermintShrimp: { name: 'Peppermint Shrimp', color: '#FF6B6B', difficulty: 'Hard', barSize: 60, fishSpeed: 0.0076, fishRandomness: 0.23, fishChangeInterval: 48, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 5, maxWeight: 8, minLength: 2, maxLength: 3, spawnWeight: 18 },
    
    // Very large fish and rays (50-500 lbs) - Hard difficulty
    atlanticTorpedoRay: { name: 'Atlantic Torpedo Ray', color: '#696969', difficulty: 'Hard', barSize: 55, fishSpeed: 0.0085, fishRandomness: 0.28, fishChangeInterval: 53, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 50, maxWeight: 200, minLength: 36, maxLength: 60, spawnWeight: 14 },
    blueSpottedRay: { name: 'Blue-Spotted Ray', color: '#4682B4', difficulty: 'Hard', barSize: 55, fishSpeed: 0.0084, fishRandomness: 0.28, fishChangeInterval: 53, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 20, maxWeight: 100, minLength: 24, maxLength: 36, spawnWeight: 16 },
    coachwhipRay: { name: 'Coachwhip Ray', color: '#8B7D6B', difficulty: 'Hard', barSize: 55, fishSpeed: 0.0085, fishRandomness: 0.28, fishChangeInterval: 53, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 30, maxWeight: 150, minLength: 48, maxLength: 72, spawnWeight: 14 },
    cownosseRay: { name: 'Cownose Ray', color: '#CD853F', difficulty: 'Hard', barSize: 55, fishSpeed: 0.0084, fishRandomness: 0.28, fishChangeInterval: 53, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 40, maxWeight: 100, minLength: 24, maxLength: 36, spawnWeight: 16 },
    eagleRay: { name: 'Eagle Ray', color: '#2F4F4F', difficulty: 'Hard', barSize: 55, fishSpeed: 0.0087, fishRandomness: 0.29, fishChangeInterval: 54, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 100, maxWeight: 500, minLength: 60, maxLength: 120, spawnWeight: 10 },
    electricRay: { name: 'Electric Ray', color: '#708090', difficulty: 'Hard', barSize: 55, fishSpeed: 0.0084, fishRandomness: 0.28, fishChangeInterval: 53, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 20, maxWeight: 80, minLength: 24, maxLength: 72, spawnWeight: 14 },
    jenkinsWhipray: { name: 'Jenkins Whipray', color: '#8B7D6B', difficulty: 'Hard', barSize: 55, fishSpeed: 0.0086, fishRandomness: 0.29, fishChangeInterval: 54, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 50, maxWeight: 300, minLength: 60, maxLength: 96, spawnWeight: 12 },
    marbledRay: { name: 'Marbled Ray', color: '#696969', difficulty: 'Hard', barSize: 55, fishSpeed: 0.0085, fishRandomness: 0.28, fishChangeInterval: 53, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 30, maxWeight: 120, minLength: 24, maxLength: 48, spawnWeight: 14 },
    whitespottedEagleRay: { name: 'Whitespotted Eagle Ray', color: '#2F4F4F', difficulty: 'Hard', barSize: 55, fishSpeed: 0.0087, fishRandomness: 0.29, fishChangeInterval: 54, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 100, maxWeight: 500, minLength: 72, maxLength: 120, spawnWeight: 10 },
    porcupineRay: { name: 'Porcupine Ray', color: '#8B7D6B', difficulty: 'Hard', barSize: 55, fishSpeed: 0.0085, fishRandomness: 0.28, fishChangeInterval: 53, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 40, maxWeight: 180, minLength: 36, maxLength: 60, spawnWeight: 12 },
    roundRay: { name: 'Round Ray', color: '#696969', difficulty: 'Hard', barSize: 55, fishSpeed: 0.0084, fishRandomness: 0.28, fishChangeInterval: 53, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 30, maxWeight: 120, minLength: 24, maxLength: 36, spawnWeight: 14 },
    roughTailStingray: { name: 'Rough Tail Stingray', color: '#708090', difficulty: 'Hard', barSize: 55, fishSpeed: 0.0086, fishRandomness: 0.29, fishChangeInterval: 54, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 50, maxWeight: 300, minLength: 48, maxLength: 84, spawnWeight: 12 },
    southernStingray: { name: 'Southern Stingray', color: '#696969', difficulty: 'Hard', barSize: 55, fishSpeed: 0.0086, fishRandomness: 0.29, fishChangeInterval: 54, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 50, maxWeight: 200, minLength: 48, maxLength: 72, spawnWeight: 14 },
    
    // Large sharks (50-500 lbs) - Hard difficulty
    blacknoseShark: { name: 'Blacknose Shark', color: '#696969', difficulty: 'Hard', barSize: 55, fishSpeed: 0.0088, fishRandomness: 0.3, fishChangeInterval: 55, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 50, maxWeight: 100, minLength: 48, maxLength: 60, spawnWeight: 14 },
    blacktipReefShark: { name: 'Blacktip Reef Shark', color: '#2F4F4F', difficulty: 'Hard', barSize: 55, fishSpeed: 0.0089, fishRandomness: 0.3, fishChangeInterval: 55, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 100, maxWeight: 300, minLength: 60, maxLength: 84, spawnWeight: 12 },
    blacktipShark: { name: 'Blacktip Shark', color: '#696969', difficulty: 'Hard', barSize: 55, fishSpeed: 0.0089, fishRandomness: 0.3, fishChangeInterval: 55, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 100, maxWeight: 200, minLength: 60, maxLength: 96, spawnWeight: 12 },
    blueShark: { name: 'Blue Shark', color: '#4682B4', difficulty: 'Hard', barSize: 50, fishSpeed: 0.011, fishRandomness: 0.4, fishChangeInterval: 52, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 100, maxWeight: 400, minLength: 96, maxLength: 150, spawnWeight: 10 },
    bullShark: { name: 'Bull Shark', color: '#808080', difficulty: 'Hard', barSize: 45, fishSpeed: 0.013, fishRandomness: 0.5, fishChangeInterval: 48, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 200, maxWeight: 500, minLength: 84, maxLength: 132, spawnWeight: 8 },
    caribbeanReefShark: { name: 'Caribbean Reef Shark', color: '#708090', difficulty: 'Hard', barSize: 50, fishSpeed: 0.0105, fishRandomness: 0.38, fishChangeInterval: 54, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 100, maxWeight: 150, minLength: 72, maxLength: 96, spawnWeight: 10 },
    duskyShark: { name: 'Dusky Shark', color: '#696969', difficulty: 'Hard', barSize: 50, fishSpeed: 0.011, fishRandomness: 0.4, fishChangeInterval: 52, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 150, maxWeight: 400, minLength: 96, maxLength: 144, spawnWeight: 10 },
    lemonShark: { name: 'Lemon Shark', color: '#F0E68C', difficulty: 'Hard', barSize: 50, fishSpeed: 0.011, fishRandomness: 0.4, fishChangeInterval: 52, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 100, maxWeight: 400, minLength: 84, maxLength: 132, spawnWeight: 10 },
    nurseShark: { name: 'Nurse Shark', color: '#8B7D6B', difficulty: 'Hard', barSize: 50, fishSpeed: 0.0105, fishRandomness: 0.38, fishChangeInterval: 54, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 100, maxWeight: 300, minLength: 84, maxLength: 120, spawnWeight: 12 },
    sandbarShark: { name: 'Sandbar Shark', color: '#D2B48C', difficulty: 'Hard', barSize: 52, fishSpeed: 0.0105, fishRandomness: 0.37, fishChangeInterval: 54, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 100, maxWeight: 200, minLength: 72, maxLength: 96, spawnWeight: 10 },
    spinnerShark: { name: 'Spinner Shark', color: '#696969', difficulty: 'Hard', barSize: 52, fishSpeed: 0.0105, fishRandomness: 0.37, fishChangeInterval: 54, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 100, maxWeight: 200, minLength: 72, maxLength: 108, spawnWeight: 10 },
    tigerShark: { name: 'Tiger Shark', color: '#8B7D6B', difficulty: 'Hard', barSize: 40, fishSpeed: 0.016, fishRandomness: 0.75, fishChangeInterval: 42, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 300, maxWeight: 1400, minLength: 132, maxLength: 216, spawnWeight: 6 },
    whitetipReefShark: { name: 'Whitetip Reef Shark', color: '#808080', difficulty: 'Hard', barSize: 55, fishSpeed: 0.01, fishRandomness: 0.35, fishChangeInterval: 55, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 50, maxWeight: 100, minLength: 48, maxLength: 60, spawnWeight: 12 },
    shortfinMakoShark: { name: 'Shortfin Mako Shark', color: '#4682B4', difficulty: 'Hard', barSize: 40, fishSpeed: 0.015, fishRandomness: 0.7, fishChangeInterval: 44, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 200, maxWeight: 1200, minLength: 96, maxLength: 168, spawnWeight: 6 },
    hammerheadShark: { name: 'Hammerhead Shark', color: '#696969', difficulty: 'Hard', barSize: 40, fishSpeed: 0.015, fishRandomness: 0.65, fishChangeInterval: 45, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 200, maxWeight: 1000, minLength: 84, maxLength: 240, spawnWeight: 6 },
    
    // Sea turtles (50-500 lbs) - Hard difficulty
    greenSeaTurtle: { name: 'Green Sea Turtle', color: '#228B22', difficulty: 'Hard', barSize: 55, fishSpeed: 0.0084, fishRandomness: 0.28, fishChangeInterval: 53, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 200, maxWeight: 500, minLength: 36, maxLength: 60, spawnWeight: 8 },
    flatbackSeaTurtle: { name: 'Flatback Sea Turtle', color: '#8B7D6B', difficulty: 'Hard', barSize: 55, fishSpeed: 0.0083, fishRandomness: 0.27, fishChangeInterval: 52, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 150, maxWeight: 200, minLength: 30, maxLength: 42, spawnWeight: 10 },
    hawksbillSeaTurtle: { name: 'Hawksbill Sea Turtle', color: '#CD853F', difficulty: 'Hard', barSize: 55, fishSpeed: 0.0083, fishRandomness: 0.27, fishChangeInterval: 52, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 100, maxWeight: 200, minLength: 24, maxLength: 36, spawnWeight: 10 },
    kempsRidleySeaTurtle: { name: "Kemp's Ridley Sea Turtle", color: '#696969', difficulty: 'Hard', barSize: 55, fishSpeed: 0.0082, fishRandomness: 0.26, fishChangeInterval: 51, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 80, maxWeight: 100, minLength: 24, maxLength: 30, spawnWeight: 12 },
    leatherbackSeaTurtle: { name: 'Leatherback Sea Turtle', color: '#2F4F4F', difficulty: 'Hard', barSize: 55, fishSpeed: 0.0087, fishRandomness: 0.29, fishChangeInterval: 54, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 500, maxWeight: 2000, minLength: 60, maxLength: 96, spawnWeight: 4 },
    loggerheadSeaTurtle: { name: 'Loggerhead Sea Turtle', color: '#8B4513', difficulty: 'Hard', barSize: 55, fishSpeed: 0.0084, fishRandomness: 0.28, fishChangeInterval: 53, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 200, maxWeight: 400, minLength: 30, maxLength: 48, spawnWeight: 8 },
    oliveRidleySeaTurtle: { name: 'Olive Ridley Sea Turtle', color: '#808000', difficulty: 'Hard', barSize: 55, fishSpeed: 0.0083, fishRandomness: 0.27, fishChangeInterval: 52, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 80, maxWeight: 100, minLength: 24, maxLength: 30, spawnWeight: 10 },
    
    // Massive marine animals (500+ lbs) - Hard difficulty
    giantGrouper: { name: 'Giant Grouper', color: '#696969', difficulty: 'Hard', barSize: 40, fishSpeed: 0.016, fishRandomness: 0.8, fishChangeInterval: 42, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 400, maxWeight: 880, minLength: 84, maxLength: 120, spawnWeight: 4 },
    goliathGrouper: { name: 'Goliath Grouper', color: '#8B7D6B', difficulty: 'Hard', barSize: 40, fishSpeed: 0.017, fishRandomness: 0.85, fishChangeInterval: 40, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 400, maxWeight: 800, minLength: 96, maxLength: 120, spawnWeight: 4 },
    atlanticGoliathGrouper: { name: 'Atlantic Goliath Grouper', color: '#696969', difficulty: 'Hard', barSize: 40, fishSpeed: 0.017, fishRandomness: 0.85, fishChangeInterval: 40, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 400, maxWeight: 800, minLength: 96, maxLength: 120, spawnWeight: 4 },
    giantMantaRay: { name: 'Giant Manta Ray', color: '#2F4F4F', difficulty: 'Hard', barSize: 35, fishSpeed: 0.019, fishRandomness: 0.9, fishChangeInterval: 38, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 1500, maxWeight: 5300, minLength: 180, maxLength: 300, spawnWeight: 0.8 },
    greatWhiteShark: { name: 'Great White Shark', color: '#C0C0C0', difficulty: 'Hard', barSize: 35, fishSpeed: 0.02, fishRandomness: 0.95, fishChangeInterval: 36, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 1500, maxWeight: 5000, minLength: 180, maxLength: 240, spawnWeight: 0.8 },
    whaleshark: { name: 'Whale Shark', color: '#4682B4', difficulty: 'Hard', barSize: 35, fishSpeed: 0.015, fishRandomness: 0.7, fishChangeInterval: 45, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 15000, maxWeight: 41000, minLength: 240, maxLength: 480, spawnWeight: 0.3 },
    oceanSunfish: { name: 'Ocean Sunfish', color: '#C0C0C0', difficulty: 'Hard', barSize: 45, fishSpeed: 0.012, fishRandomness: 0.5, fishChangeInterval: 50, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 500, maxWeight: 5000, minLength: 72, maxLength: 132, spawnWeight: 1.5 },
    bluefinTuna: { name: 'Bluefin Tuna', color: '#4682B4', difficulty: 'Hard', barSize: 45, fishSpeed: 0.013, fishRandomness: 0.55, fishChangeInterval: 48, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 500, maxWeight: 1500, minLength: 96, maxLength: 120, spawnWeight: 2 },
    marlin: { name: 'Marlin', color: '#4169E1', difficulty: 'Hard', barSize: 45, fishSpeed: 0.014, fishRandomness: 0.6, fishChangeInterval: 46, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 500, maxWeight: 1800, minLength: 120, maxLength: 180, spawnWeight: 2 },
    sailfish: { name: 'Sailfish', color: '#4682B4', difficulty: 'Hard', barSize: 50, fishSpeed: 0.012, fishRandomness: 0.5, fishChangeInterval: 50, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 100, maxWeight: 220, minLength: 72, maxLength: 132, spawnWeight: 3 },
    swordfish: { name: 'Swordfish', color: '#708090', difficulty: 'Hard', barSize: 45, fishSpeed: 0.013, fishRandomness: 0.55, fishChangeInterval: 48, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 200, maxWeight: 1400, minLength: 96, maxLength: 180, spawnWeight: 2.5 },
    orca: { name: 'Orca', color: '#000000', difficulty: 'Hard', barSize: 30, fishSpeed: 0.018, fishRandomness: 0.85, fishChangeInterval: 35, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 8000, maxWeight: 12000, minLength: 240, maxLength: 384, spawnWeight: 0.4 },
    humpbackWhale: { name: 'Humpback Whale', color: '#696969', difficulty: 'Hard', barSize: 25, fishSpeed: 0.022, fishRandomness: 1.0, fishChangeInterval: 30, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 40000, maxWeight: 80000, minLength: 480, maxLength: 720, spawnWeight: 0.2 },
    grayWhale: { name: 'Gray Whale', color: '#808080', difficulty: 'Hard', barSize: 25, fishSpeed: 0.021, fishRandomness: 0.95, fishChangeInterval: 32, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 30000, maxWeight: 80000, minLength: 420, maxLength: 600, spawnWeight: 0.2 },
    spermWhale: { name: 'Sperm Whale', color: '#2F4F4F', difficulty: 'Hard', barSize: 25, fishSpeed: 0.023, fishRandomness: 1.05, fishChangeInterval: 28, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 35000, maxWeight: 90000, minLength: 480, maxLength: 780, spawnWeight: 0.15 },
    blueWhale: { name: 'Blue Whale', color: '#4682B4', difficulty: 'Hard', barSize: 20, fishSpeed: 0.025, fishRandomness: 1.2, fishChangeInterval: 25, progressGainRate: 0.3, progressDecayRate: 0.3, minWeight: 200000, maxWeight: 400000, minLength: 900, maxLength: 1200, spawnWeight: 0.1 }
};
